 ...
 */
externals.validate = (alias, flags, command) => {
  ...
  if (externals.validateSystemFlag(flags)) {
    return true;
  }
...
externals.validateSystemFlag = (flags) => {

  const parsedFlags = Flags.parseFlags(flags);
